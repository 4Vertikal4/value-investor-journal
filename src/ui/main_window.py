...
class MainWindow(QMainWindow):
    ...
    def build_actions(self) -> None:
        self.add_action = QAction(UI["add_position"], self)
        self.add_action.setShortcut(QKeySequence("Ctrl+N"))
        self.review_action = QAction(UI["add_review"], self)
        self.review_action.setShortcut(QKeySequence("Ctrl+R"))
        self.import_action = QAction(UI["import_csv"], self)
        self.import_action.setShortcut(QKeySequence("Ctrl+I"))
        self.export_xlsx_action = QAction("Eksport XLSX", self)
        self.export_xlsx_action.setShortcut(QKeySequence("Ctrl+E"))
        self.export_csv_action = QAction("Eksport CSV", self)
        self.backup_action = QAction("Backup bazy", self)
        ...
        self.show_closed_action = QAction("Pokaż zamknięte", self)
        self.show_closed_action.setCheckable(True)
        self.refresh_metrics_action = QAction("Odśwież metryki", self)
        self.notifications_action = QAction("Powiadomienia", self)
    ...
    def connect_signals(self) -> None:
        ...
        self.backup_action.triggered.connect(self.export_backup_file)
